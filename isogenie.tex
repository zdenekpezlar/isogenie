...
\frac{3x_1 ^2 + a}{2y_1}, \text{ pokud } x_1 = x-2.
\end{cases}
\end{equation*}
...
\end{definice}
\begin{definice}
Pod stupňem isogenie $\phi$ budeme rozumět jejímu stupni jako racionální funkci a budeme značit $\deg \phi$. Obraz křivky $E$ v $\phi$ budeme značit $\phi(E)$.
\end{definice}
